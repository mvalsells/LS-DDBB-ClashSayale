...
DELETE FROM requereix_tecnologia;
DELETE FROM estructura;
DELETE FROM requereix_estructura;
DELETE FROM clan;
...
DELETE FROM edifici;
DELETE FROM tropa;
DELETE FROM encanteri;
DELETE FROM jugador;
DELETE FROM targeta_credit;
DELETE FROM batalla;
DELETE FROM lluiten;
DELETE FROM pila;
DELETE FROM missio;
DELETE FROM completen;
DELETE FROM pertany;
DELETE FROM comparteixen;
DELETE FROM missatge;
DELETE FROM arena_pack;
DELETE FROM nivellcarta;
DELETE FROM compren;
DELETE FROM article;
DELETE FROM cofre;
DELETE FROM emoticones;
DELETE FROM bundle;
DELETE FROM depen;
...
-- Afegim la temporada corresponent a cada batalla
UPDATE batalla
SET id_temporada = temporada.id_temporada
FROM temporada
WHERE batalla.data <= temporada.data_fi AND batalla.data >= temporada.data_inici;

COPY participen
FROM 'C:\Users\Public\Creats\participen.csv'
DELIMITER ','
CSV HEADER;
